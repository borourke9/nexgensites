          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="flex items-center space-x-2 text-sm font-medium text-pink-600">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    ...
                    className="bg-gradient-to-r from-pink-500 to-orange-400 hover:from-pink-600 hover:to-orange-500 text-white font-semibold px-8 py-4 rounded-full shadow-xl shadow-pink-500/25 border-0 group cursor-pointer"
                  >
                    🚀 Build My System
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-2 border-gray-300 hover:border-pink-400 px-8 py-4 rounded-full font-semibold bg-transparent cursor-pointer"
                  >
                    View Case Studies
                  </Button>
                </div>
            ...
            <div className="mt-16 pt-8 border-t border-gray-200">
              <div className="text-center mb-8">
                <p className="text-sm text-gray-500 font-medium">TRUSTED BY FORWARD-THINKING BUSINESSES</p>
              </div>
