      ...
      <div id="home" className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50 to-rose-50 relative overflow-hidden">
        ...
        <main className="relative px-6 py-12 md:py-20 lg:py-32">
          <div className="relative max-w-7xl mx-auto">
            {/* Hero Content - Clean Two-Column Layout */}
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              {/* Left Column - Content */}
              <div className="text-center lg:text-left space-y-8 lg:pl-8">
              ...
              {/* Right Column - Modern MacBook Pro Mockup */}
              <div 
              ...
              >
                <div className="relative w-full max-w-md lg:max-w-lg">
                  ...
                  >
                    {/* MacBook Pro Frame */}
                    <div className="relative bg-stone-800 rounded-2xl p-4 shadow-2xl">
                      {/* Screen Bezel */}
                      ...
                      {/* MacBook Base */}
                      <div className="mt-3 h-3 bg-stone-700 rounded-b-lg"></div>
                      {/* MacBook Stand */}
                      <div className="mt-2 h-1 bg-stone-600 rounded-full mx-auto w-16"></div>
                    </div>
