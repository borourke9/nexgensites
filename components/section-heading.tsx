    ...
    <div ref={titleRef} className={`text-center mb-12 sm:mb-16 lg:mb-20 ${className}`}>
      <h2
        className={`
          ...
          font-light leading-tight tracking-wide text-stone-900 mb-4 sm:mb-6
      ...
      {showUnderline && (
        <div
          className={`
            w-16 sm:w-20 lg:w-24 h-0.5 bg-gradient-to-r from-[#B00C2F] via-rose-400 to-amber-300 
      ...
      {subtitle && (
        <p
          className={`
            text-base sm:text-lg lg:text-xl text-stone-600 max-w-2xl lg:max-w-3xl 
            mx-auto leading-relaxed font-medium
